...
unset PYTHONHOME
unset PYTHONPATH
mkdir job117334611_mg_ee_ZHH_ecm365
cd job117334611_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 117334611
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_117334611.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job117334611_mg_ee_ZHH_ecm365
