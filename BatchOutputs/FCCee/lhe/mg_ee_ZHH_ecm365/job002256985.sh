...
unset PYTHONHOME
unset PYTHONPATH
mkdir job002256985_mg_ee_ZHH_ecm365
cd job002256985_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 2256985
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_002256985.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job002256985_mg_ee_ZHH_ecm365
