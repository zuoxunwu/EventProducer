...
unset PYTHONHOME
unset PYTHONPATH
mkdir job065233795_mg_ee_ZHH_ecm365
cd job065233795_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 65233795
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_065233795.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job065233795_mg_ee_ZHH_ecm365
