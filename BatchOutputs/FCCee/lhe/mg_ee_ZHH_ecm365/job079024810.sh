...
unset PYTHONHOME
unset PYTHONPATH
mkdir job079024810_mg_ee_ZHH_ecm365
cd job079024810_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 79024810
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_079024810.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job079024810_mg_ee_ZHH_ecm365
