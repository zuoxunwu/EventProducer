...
unset PYTHONHOME
unset PYTHONPATH
mkdir job061619122_mg_ee_ZHH_ecm365
cd job061619122_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 61619122
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_061619122.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job061619122_mg_ee_ZHH_ecm365
