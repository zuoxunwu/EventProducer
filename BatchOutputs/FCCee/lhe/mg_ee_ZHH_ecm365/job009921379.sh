...
unset PYTHONHOME
unset PYTHONPATH
mkdir job009921379_mg_ee_ZHH_ecm365
cd job009921379_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 9921379
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_009921379.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job009921379_mg_ee_ZHH_ecm365
