...
unset PYTHONHOME
unset PYTHONPATH
mkdir job112602630_mg_ee_ZHH_ecm365
cd job112602630_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 112602630
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_112602630.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job112602630_mg_ee_ZHH_ecm365
