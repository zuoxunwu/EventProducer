...
unset PYTHONHOME
unset PYTHONPATH
mkdir job011604054_mg_ee_ZHH_ecm365
cd job011604054_mg_ee_ZHH_ecm365
...
cd process/
./run.sh 100000 11604054
echo "finished run"
xrdcp -N -v events.lhe.gz root://eospublic.cern.ch//eos/experiment/fcc/ee/generation/lhe//mg_ee_ZHH_ecm365/events_011604054.lhe.gz
echo "lhe file successfully copied on eos"
cd ..
rm -rf job011604054_mg_ee_ZHH_ecm365
